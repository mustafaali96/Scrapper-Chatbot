                ...
                if (site.length > 0) {
                    if (per.Name.toLowerCase() === product && per.Site.toLowerCase() == site.toLowerCase()) {
                        ...
                        if (per.discounted_price !== "") {
                            text_response += `at discounted price of rupees ${per.discounted_price}, original price was rupees ${per.original_price}.`;
                        }
                        else {
                            text_response += `at rupees ${per.original_price}.`;
                        }
                    }
                } 
                else {
